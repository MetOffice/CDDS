...
def extract_version():
    """
    Return the version number of CDDS Template.
    """
    filename = os.path.join('cdds_template', '__init__.py')
...
setup(name='cdds_template',
      version=extract_version(),
      description=('The CDDS Template package [...].'),
      long_description=extract_readme(),
      keywords='cdds template',
      url='https://code.metoffice.gov.uk/trac/cdds',
      author='A. N. Other',
      author_email='a.n.other@metoffice.gov.uk',
      maintainer='A. N. Other',
      maintainer_email='a.n.other@metoffice.gov.uk',
      platforms=['Linux', 'Unix'],
      package_data={'cdds_template': ['arguments.json']},
