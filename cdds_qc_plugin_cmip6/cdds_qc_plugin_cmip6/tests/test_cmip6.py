...
from cdds_qc_plugin_cmip6.cmip6 import CMIP6Check
from cdds_qc_plugin_cmip6.tests.constants import (
...
class TestCMIP6Check(unittest.TestCase):
    ...
    @patch("cdds_qc_plugin_cmip6.validators.CVConfig.parent_experiment_id")
