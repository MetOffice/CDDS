...
class TestDefaultModelJsonFiles(TestCase):
    ...
    def setUp(self) -> None:
        model_dir_relative_path = 'cdds_plugins/cmip6/data/model'

        cdds_common_dir = Path(__file__).parent.parent.parent.parent
        model_dir = cdds_common_dir.joinpath(cdds_common_dir, model_dir_relative_path).absolute()
        self.model_files = [
