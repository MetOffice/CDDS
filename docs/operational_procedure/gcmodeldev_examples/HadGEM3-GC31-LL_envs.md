# GCModelDev HadGEM3 GC31 LL request file example (ens MASS data class)
...
variant_label = r21i1p1f3
model_id = HadGEM3-GC31-LL
model_type = AOGCM AER

[netcdf_global_attributes]
mass_ensemble_member = r011i1p1f1
...
model_workflow_id = u-cp832
model_workflow_branch = trunk
model_workflow_revision = not used except with Concatenation Period
streams = ap5 onm
