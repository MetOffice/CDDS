...
"""
Setup script for the CDDS QC package.
"""
import imp
import os
...
def extract_version():
    """
    Return the version number of CDDS QC.
    """
    filename = os.path.join('cdds_qc', '__init__.py')
...
def extract_readme():
    """
    Return the contents of the README.rst file in CDDS QC.
    """
...
setup(name='cdds_qc',
      ...
      description=('The CDDS QC package enables a user to check '
                   'whether the output netCDF files conform to '
                   'the WGCM CMIP standards.'),
      ...
      package_data={'cdds_qc': ['arguments.json']},
