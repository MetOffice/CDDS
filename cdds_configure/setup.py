...
"""
Setup script for the CDDS Configure package.
"""
import imp
import os
...
def extract_version():
    """
    Return the version number of CDDS Configure.
    """
    filename = os.path.join('cdds_configure', '__init__.py')
...
def extract_readme():
    """
    Return the contents of the README.rst file in CDDS Configure.
    """
...
setup(name='cdds_configure',
      version=extract_version(),
      description=('The CDDS Configure package enables a user to produce the '
                   'user configuration file for MIP Convert.'),
      long_description=extract_readme(),
      keywords='cdds configure',
      ...
      package_data={'cdds_configure': ['arguments.json']},
