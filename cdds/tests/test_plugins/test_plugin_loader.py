...
from common.plugins.exceptions import PluginLoadError
from common.plugins.plugin_loader import load_external_plugin, load_cmip_plugin, load_plugin
from common.plugins.cmip6.cmip6_plugin import Cmip6Plugin
from common.plugins.gcmodeldev.gcmodeldev_plugin import GCModelDevPlugin
...
class TestLoadPlugin(TestCase):
    ...
    def test_load_cdds_plugin(self):
        module_path = 'tests.test_plugins.stubs'
    ...
    def test_no_plugin_implemented_at_module_path(self):
        module_path = 'tests.test_plugins.test_grid'
        self.assertIsNone(self.plugin_store.get_plugin())
