...
from common.cdds_plugins.models import ModelsStore
from common.cdds_plugins.grid import GridType
from common.cdds_plugins.base.base_grid import AtmosBaseGridInfo, OceanBaseGridInfo
from common.cdds_plugins.streams import StreamFileInfo
from common.cdds_plugins.cmip6.cmip6_models import Cmip6ModelsStore, HadGEM3_GC31_LL_Params, Cmip6ModelId
...
class TestDefaultModelJsonFiles(TestCase):
    ...
    def setUp(self) -> None:
        model_dir_relative_path = 'common/cdds_plugins/cmip6/data/model'
