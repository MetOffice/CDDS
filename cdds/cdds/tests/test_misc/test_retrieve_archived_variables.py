...
from cdds.misc.retrieve_archived_variables import transfer_files
...
class TestTransferFiles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tmp_output_dir = Path(mkdtemp(prefix="test_output_dir_"))
        self.output_dir = self.tmp_output_dir / "output"
        self.output_dir.mkdir(parents=True, exist_ok=True)

    def tearDown(self):
        shutil.rmtree(self.tmp_output_dir)

    @patch("cdds.misc.retrieve_archived_variables.run_mass_command")
    ...
    @patch(
        "cdds.misc.retrieve_archived_variables.run_mass_command",
