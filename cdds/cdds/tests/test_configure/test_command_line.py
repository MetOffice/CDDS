...
class TestMain(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.shuffle = 'True'
        self.sites_file = '/gws/nopw/j04/mohc_shared/cdds/etc/cfmip2/cfmip2-sites-orog.txt'
        self.sub_experiment_id = 'none'
        self.suite_id = 'u-aw310'
        self.variant_label = 'r1i1p1f2'
        # User config:
        self.ancil_files = ('/gws/nopw/j04/mohc_shared/cdds/etc/ancil/UKESM1-0-LL/qrparm.landfrac.pp '
        ...
        self.hybrid_heights_files = ('/gws/nopw/j04/mohc_shared/cdds/etc/'
                                     'vertical_coordinates/atmosphere_theta_levels_85.txt '
                                     '/gws/nopw/j04/mohc_shared/cdds/etc/'
                                     'vertical_coordinates/atmosphere_rho_levels_86.txt')
        plugin = PluginStore.instance().get_plugin()
        grid_info = plugin.grid_info(self.model_id, GridType.ATMOS)
        self.nominal_resolution = grid_info.nominal_resolution
        self.replacement_coordinates_file = ('/gws/nopw/j04/mohc_shared/cdds/etc/'
