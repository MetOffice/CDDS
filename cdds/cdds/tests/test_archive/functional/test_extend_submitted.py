...
from cdds.tests.test_archive.functional.data.test_data_creator import create_use_case3_data
...
class TestStoreExtendSubmitted(StoreTestCase):
    ...
    def test_transfer_functional_usecase3_extend_submitted(self, mock_log_datestamp):
        test_dir = create_use_case3_data('piControl_10096_proc', 'piControl_10096_data')
        test_data = TestData(
            number_variables=1,
