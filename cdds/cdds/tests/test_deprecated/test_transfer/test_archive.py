...
from cdds.deprecated.transfer.archive import (allowed_mass_locations,
                                              DEVELOPMENT_MASS_DIR, PRODUCTION_MASS_DIR)


class TestAllowedMassLocations(unittest.TestCase):
    @patch('cdds.deprecated.transfer.archive._DEV', False)
    ...
    @patch('cdds.deprecated.transfer.archive._DEV', True)
