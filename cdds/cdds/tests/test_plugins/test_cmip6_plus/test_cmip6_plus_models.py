...
from cdds.common.plugins.cmip6_plus.cmip6_plus_models import (
    Cmip6PlusModelsStore, HadGEM3_GC31_LL_Params, Cmip6PlusModelId
)
...
class TestModelsStore(TestCase):
    ...
    def setUp(self):
        Cmip6PlusModelsStore.clean_instance()

    def tearDown(self):
        Cmip6PlusModelsStore.clean_instance()

    def test_get_model_params_for_hadgem3_gc31_ll(self):
        store = Cmip6PlusModelsStore.instance()
        model_params = store.get(Cmip6PlusModelId.HadGEM3_GC31_LL.value)
...
class TestModelId(TestCase):
    ...
    def test_enum_definition(self):
        ...
        value = Cmip6PlusModelId.HadGEM3_GC31_LL.value
        self.assertEqual(value, 'HadGEM3-GC31-LL')

    def test_get_json_file_name(self):
        json_file = Cmip6PlusModelId.HadGEM3_GC31_LL.get_json_file()
...
class TestDefaultModelJsonFiles(TestCase):
    ...
    def test_default_json_files_for_HadGEM3_GC31_LL(self):
        json_file_name = Cmip6PlusModelId.HadGEM3_GC31_LL.get_json_file()
