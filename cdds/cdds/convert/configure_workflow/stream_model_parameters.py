...
class StreamModelParameters:
    def __init__(self, request: Request, stream: str, components: StreamComponents):
        ...
        request : Request
            A Request class.
        stream : str
            The stream to retrieve model parametr information for.
        components : StreamComponents
            The grid and substream information.
        """
    ...
    def concatenation_period(self) -> Duration:
        ...
        -------
        Duration
            The concatenation period to be used for the given self.stream
        """
    ...
    def check_cycle_freq_exceeds_run_bounds(self, cycle_frequency: Duration) -> Duration:
        ...
        Parameters
        ----------
        cycle_frequency : Duration
            The default cycling frequency as a duration string e.g. P5Y

        Returns
        -------
        Duration
            A cycling frequency compatible with the run bounds.
        """
    ...
    def memory(self) -> dict[str, str]:
        ...
        -------
        dict[str, str]
            The required memory for this stream.
        """
    ...
    def as_jinja2(self) -> dict:
        ...
        -------
        dict
            A dictionary with Jinja2 template variables.
        """
        return {
            'STREAMS': self.stream,
