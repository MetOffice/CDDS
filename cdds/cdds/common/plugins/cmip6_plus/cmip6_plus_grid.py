...
"""The :mod:`cmip6_plus_grid` module contains the code required
handle grid information for CMIP6Plus models.
"""
from cdds.common.plugins.grid import GridLabel


class Cmip6PlusGridLabel(GridLabel):
    ...
    * a flag to specify if label requires extra information
    ...
    def from_name(cls, name: str) -> 'GridLabel':
        ...
        """
        for grid_label in Cmip6PlusGridLabel:
