...
def main_list_queue() -> int:
    ...
    parser.add_argument('queue', choices=KNOWN_QUEUES, help='Name of the queue to list')
    parser.add_argument('--full', action='store_true', help='Full message output rather than just dataset ids')
    args = parser.parse_args()
