...
"""
Setup script for the Extract package.
"""
import imp
import os
...
def extract_version():
    """
    Return the version number of Extract.
    """
    filename = os.path.join('extract', '__init__.py')
...
def extract_readme():
    """
    Return the contents of the README.rst file in Extract.
    """
...
setup(name='extract',
      ...
      description=('The Extract package enables a user to extract model '
                   'output files from MASS.'),
      long_description=extract_readme(),
      keywords='extract netcdf model request variable transform pp',
      url='https://code.metoffice.gov.uk/trac/cdds',
      author='Mark Elkington and Piotr Florek',
      author_email='piotr.florek@metoffice.gov.uk',
      maintainer='Piotr Florek',
      maintainer_email='piotr.florek@metoffice.gov.uk',
      platforms=['Linux', 'Unix'],
      packages=find_packages(),
      package_data={'extract': ['arguments.json']},
