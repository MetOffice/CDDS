...
"""
The :mod:`eukesm1_plugin` module contains the code for the eUKESM1 plugin.
"""
import iris.cube
import os
...
from mip_convert.plugins.eukesm1.data.processors import *


class eUKESM1MappingPlugin(BaseMappingPlugin):
    """
    Plugin for eUKESM1 models
    """

    def __init__(self):
        data_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data')
        super(eUKESM1MappingPlugin, self).__init__('eUKESM1', data_dir)
