...
def produce_mip_requested_variable(
    ...
    variable_metadata = VariableMetadata(
        ...
        user_config.deflate_level, user_config.shuffle, user_config.force_coordinate_rotation,
        user_config.reference_time, user_config.masking, user_config.halo_removals
    )
