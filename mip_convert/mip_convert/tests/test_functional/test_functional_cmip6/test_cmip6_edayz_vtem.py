...
from mip_convert.tests.test_functional.utils.constants import TEST_CASE_LOCATION, ROOT_ANCIL_DIR_NEW
...
class TestCmip6EdayZVtem(AbstractFunctionalTests):
    ...
    def get_test_data(self):
        ...
        test_location = os.path.join(TEST_CASE_LOCATION, 'test_CMIP6_EdayZ_vtem')
