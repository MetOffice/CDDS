...
"""
Setup script for the cdds_prepare package.
"""
import imp
import os
...
def extract_version():
    """
    Return the version number of cdds_prepare.
    """
    filename = os.path.join('cdds_prepare', '__init__.py')
...
def extract_readme():
    """
    Return the contents of the README.rst file in cdds_prepare.
    """
...
setup(name='cdds_prepare',
      version=extract_version(),
      description=('Tools for preparing configuration files for the '
                   'CDDS system'),
      long_description=extract_readme(),
      keywords='cdds_prepare',
      ...
      package_data={'cdds_prepare': ['arguments.json']},
