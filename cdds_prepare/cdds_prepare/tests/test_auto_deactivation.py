...
from cdds_prepare.auto_deactivation import deactivation_commands
...
class TestDeactivationCommands(unittest.TestCase):
    @patch('cdds_prepare.auto_deactivation.run_command')
    @patch('cdds_prepare.auto_deactivation.check_svn_location')
    ...
    @patch('cdds_prepare.auto_deactivation.read_json')
