...
`python scripts/update_variables_from_valdiate.py <request> --streams <streams>`
"""
import argparse
import configparser
import datetime
...
def arg_parser() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description=("Amend variable list files by commenting out variables identified "
                                                  "by extract validation as unproducible due to stash errors."))
...
def main() -> None:
    ...
    # path cannot be found, attempt to replace any instance of ~ with path home.
